...
urlpatterns = [
    ...
    path('eliminar_tatuador/<int:tatuador_id>/', views.eliminar_tatuador, name='eliminar_tatuador'),
    path('editar_tatuador/<int:tatuador_id>/', views.editar_tatuador, name='editar_tatuador'),
